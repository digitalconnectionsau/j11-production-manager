        ...
        >
          ...
          <div className="mb-6">
            <button
              ...
              className="bg-primary hover:opacity-90 text-white px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              + Add Status
            </button>
          </div>
          ...
          {(isAddMode || editingStatus) && (
            <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-light-grey">
              ...
              <div className="flex gap-2 mt-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="bg-light-grey hover:bg-gray-300 text-charcoal px-4 py-2 rounded-lg font-medium transition-colors"
                >
                  Cancel
                </button>
              </div>
          ...
          <div className="space-y-2">
            {statuses.map((status, index) => (
              <div
                key={status.id}
                className="flex items-center justify-between p-4 bg-white border border-light-grey rounded-lg hover:shadow-sm transition-shadow"
              >
          ...
          {loading && statuses.length === 0 && (
            <div className="flex justify-center items-center py-8">
              ...
              <span className="ml-2 text-charcoal">Loading statuses...</span>
            </div>
          )}
