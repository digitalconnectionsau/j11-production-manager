        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">J11 Production Manager</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your production tasks and projects from this dashboard.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="p-4 text-left border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-colors">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Create Task</h4>
                  <p className="text-sm text-gray-500">Add a new production task</p>
                </div>
              </div>
            </button>
            ...
            <button className="p-4 text-left border-2 border-dashed border-gray-300 rounded-lg hover:border-purple-400 hover:bg-purple-50 transition-colors">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Check production analytics</p>
                </div>
              </div>
            </button>
          </div>
